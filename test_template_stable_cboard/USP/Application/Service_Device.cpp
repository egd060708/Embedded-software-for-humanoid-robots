...
//		clk1 = HAL_RCC_GetSysClockFreq();
//		clk2 = HAL_RCC_GetHCLKFreq();
//		clk3 = HAL_RCC_GetPCLK1Freq();
//		clk4 = HAL_RCC_GetPCLK2Freq();
//		uint32_t tick = HAL_GetTick();
//		clkcount = (float)tick * 0.001;

		if(is_going == 1){
			lkmotor.speedControl(60);
		}
		else if(is_going == 2){
			lkmotor.iqCloseControl_Current(100);
		}
		else{
